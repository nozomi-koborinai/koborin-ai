...
| WIF | [Workload Identity Federation](https://cloud.google.com/iam/docs/workload-identity-federation) | Authentication from GitHub Actions to Google Cloud |
| IAP | [Identity-Aware Proxy](https://cloud.google.com/iap/docs/concepts-overview) | Access control using Google accounts |
