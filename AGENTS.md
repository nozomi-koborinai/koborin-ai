...
This document is a quick guide for any contributors or AI agents that touch the `n-koborinai.me` repository.

## Mission

- Personal site + technical garden for `n-koborinai`.
...
4. **Environments**:
   ...
   - `dev`: Cloud Run service `n-koborinai-me-web-dev` (to be created).
   - `prod`: Cloud Run service `n-koborinai-me-web-prod` (to be created).
