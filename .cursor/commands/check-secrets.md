...
- Hardcoded project IDs: `n-koborinai-me` (when not in variable assignments or docs)
- Email addresses: `@n-koborinai\.(me|com|jp)`
...
For `n-koborinai-me`:
- Allow `n-koborinai-me` in `infrastructure/` and `README.md` (expected)
...
ℹ️  INFO: Domain reference
  ...
  Line: 12
  Match: https://n-koborinai.me/api/contact
